...
const ButtonComponents = ({
  ...
  const buttonBase1Material = useMemo(
  ...
  const buttonBase2Material = useMemo(
    () => new THREE.MeshBasicMaterial({
      transparent: true,
      opacity: 0.3,
      color: "white"
...
const Ecctrl = ({
  ...
  const characterModelIndicator = useMemo(
    () => new THREE.Object3D(),
    []
  );
  ...
  const bodyBalanceVecOnX = useMemo(
    () => new THREE.Vector3(),
    []
  );
  const bodyFacingVecOnY = useMemo(
    () => new THREE.Vector3(),
    []
  );
  const bodyBalanceVecOnZ = useMemo(
    () => new THREE.Vector3(),
    []
  );
  ...
  const gamepadJoystickVec2 = useMemo(
    () => new THREE.Vector2(),
    []
  );
  ...
  const standingForcePoint = useMemo(
    () => new THREE.Vector3(),
    []
  );
  const movingObjectDragForce = useMemo(
    () => new THREE.Vector3(),
    []
  );
  const movingObjectVelocity = useMemo(
    () => new THREE.Vector3(),
    []
  );
  ...
  const objectAngvelToLinvel = useMemo(
    () => new THREE.Vector3(),
    []
  );
  ...
  const characterMassForce = useMemo(
    () => new THREE.Vector3(),
    []
  );
  ...
  const actualSlopeNormalVec = useMemo(
    () => new THREE.Vector3(),
    []
  );
